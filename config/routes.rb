Lobsters::Application.routes.draw do
  ...
  root :to => "home#index",
    :protocol => (Rails.env == "production" ? "http://" : "http://")
  ...
  get "/p(.format)" => "home#p"
  get "/p/page/:page" => "home#p"
  # get "/p/:user" => "home#photo_by_user"
  # get "/p/:user/page/:page" => "home#photo_by_user"
  ...
  get "admin/index"
  get "admin/biz_email"
  post "/sent_biz_email" => "admin#sent_biz_email"
end
